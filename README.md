# Learning Golang
This repository organize a list of links that I collect while 
I learning the Go Programming Language.

## How setup a Golang Environment (`Linux`)
- [Fix your $GOPATH and $GOROOT](https://bit.ly/2MeIZzX)
- [Installing Go and $GOPATH](https://bit.ly/2Mh9NiM)
- [You don’t need to set GOROOT, really](https://bit.ly/2McO0sC)
...
- [GoLang: Glide for Go language package management](https://bit.ly/2Mg7kFn)
- [what should be the values of GOPATH and GOROOT? - StackOverflow](https://bit.ly/2MfUtTV)
...
- [Golang Package Management - YouTube](https://bit.ly/2Mf5LYt)
- [Go project file structure? - Reddit](https://bit.ly/2MfORJl)
